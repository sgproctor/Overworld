...
//         maxRiverWidth =  MapManager.Instance.generationMinDistance / 3f;
//         widthMultiplier = (maxRiverWidth / WeatherManager.Instance.maxWaterLevel) / maxRivertoMaxWaterLevel;
//         // the more cells the larger the rivers can get (lower generation size equates to more cells)
//         fluxToPrecipitationMultiplier = MapManager.Instance.generationMinDistance;
...
//     {
//         cell.river = gameObject.GetComponent<old.River>();
...
//             //if connecting cell
//             else if((minHeight > MapManager.Instance.oceanHeight) && (minHeight < cell.height) && (!lowestNeighbor.river))
//             {         
