...
//         if(rainAmount <= 0f)
//         {
//             if(!WeatherManager.Instance.isStormAlive && WeatherManager.Instance.stormsAlive <= 1)
//             {
//                 WeatherManager.Instance.StartRivers();
//             }
//             WeatherManager.Instance.stormsAlive--;
//             Destroy(gameObject);
//         }
...
//                 WeatherManager.Instance.maxWaterLevel = Mathf.Max(cell.precipitation,WeatherManager.Instance.maxWaterLevel);
//                 rainAmount -= rainRate;
//             }
//         }
